...
public class MergeStringTests extends TestCase {
   ...
   public void testAlphabet() {
        ...
        if(!MergeTD.isSorted(arr)) fail("FAILED LOWERCASE ALPHABET TEST!!");
    }
    ...
    public void testReverseAlphabet() {
        ...
        if(!MergeTD.isSorted(arr)) fail("FAILED LOWERCASE REVERSE ALPHABET TEST!!");
    }
    ...
    public void testUpperAlphabet() {
        ...
        if(!MergeTD.isSorted(arr)) fail("FAILED UPPERCASE ALPHABET TEST!!");
    }
    ...
    public void testReverseUpperAlphabet() {
        ...
        if(!MergeTD.isSorted(arr)) fail("FAILED UPPERCASE REVERSE ALPHABET TEST!!");
    }
    ...
    public void testMixAlphabetCases(){
        ...
        if(!MergeTD.isSorted(arr)) fail("FAILED MIXED ALPHABET TEST!!");
    }
    ...
    public void testNumbers() {
        ...
        if(!MergeTD.isSorted(arr)) fail("FAILED NUMBERS TEST!!");
    }
    ...
    public void testReverseNumbers() {
        ...
        if(!MergeTD.isSorted(arr)) fail("FAILED REVERSE NUMBERS TEST!!");
    }
    ...
    public void testRandomFixedStrings() {
        ...
        if(!MergeTD.isSorted(arr)) fail("FAILED RANDOM FIXED STRINGS TEST!!");
    }
    ...
    public void testRandomStrings() {
        ...
        if(!MergeTD.isSorted(arr)) fail("FAILED RANDOM STRINGS TEST!!");
    }
    ...
    public static void testSingleString() {
         ...
         if(!MergeTD.isSorted(testEmpty)) fail("FAILED SINGLE CHARACTER TEST!!");
     }    
}
